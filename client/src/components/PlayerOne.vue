  ...
  <div class="super-container">
    ...
    <div class="card-container">
      ...
      >
        <br />
        <p class="property">
          <!-- this is hiding css under it -->
          <span>{{playerOneCards[0].name}}</span>
        </p>
    ...
    <div class="cards-left">
      <p>Current Cards In Deck: {{this.playerOneCards.length}}</p>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleClick(property) {
      eventBus.$emit("playerone-property-selected", {
        playerOneCard: this.playerOneCards[0],
        property: property
      });
